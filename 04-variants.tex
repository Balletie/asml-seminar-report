...
hypothesis is correct is reached. Although this approach does not guarantee a
correct result of the equivalence query, it is still used in practice
\cite{Cho2010,Bauer2014}; often in combination with more robust alternatives
such as Chow's W-method.


\subsubsection{Chow's W-method}
\label{sec:chow}

Chow's W-method is a form a model-based testing \cite{deRuiter2015, Chow1978}.
