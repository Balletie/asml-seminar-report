...
\begin{itemize}
  \item TTT (\& based on discrimination trees, \cite{} \todo{cite Kearns / vazirani}
  \item Observation pack algorithm \todo{}
  \todo{Isberner, M., Howar, F., Steffen, B.: The TTT algorithm: A redundancy-free approach to active automata learning.}
\end{itemize}
