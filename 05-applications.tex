...
independent\todo{citation}. In practice this often means that applications have
...
queries\todo{maybe tens of thousand? millions? Give example of real world
application that took hours, if not days? Add citation}. This means that the
...
number of states in the system is known.\todo{Mention Wp-method\cite{Fujiwara91}
and more examples?}
