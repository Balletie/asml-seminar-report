...
$T(s_1,\sigma\concat e)$ is unequal with $T(s_2,\sigma\concat e)$. Thus,
$\sigma\concat e$ defines a new distinguishing extension, and should be added to
$E$. Again, the table is filled by executing membership queries where needed.
