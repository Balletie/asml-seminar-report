...
only if $\nero_\lang$ is finite. Thus, since this article is concerned with
learning regular languages, the set of equivalence classes must be finite. And
since the active learning algorithms that will be discussed guarantee progress,
the process of learning is guaranteed to converge.
...
% Explain membership and equivalence queries and relationship with key
%   principles.
